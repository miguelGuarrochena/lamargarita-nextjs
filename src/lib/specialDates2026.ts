...
export const argentineHolidays2026: CalendarEvent[] = [
  ...
  },
  {
    ...
    booking: "FR" as BookingType,
    start: new Date(2026, 2, 23), // March 23
  ...
  },
  {
    ...
    booking: "FR" as BookingType,
    start: new Date(2026, 5, 15), // June 15
  ...
  },
  {
    ...
    booking: "FR" as BookingType,
    start: new Date(2026, 10, 23), // November 23
    end: new Date(2026, 10, 23),
    pax: 1,
    user: { _id: ADMIN_USER_ID, name: "ADMIN" },
  },
  {
    ...
    booking: "FR" as BookingType,
    start: new Date(2026, 11, 7), // December 8
    end: new Date(2026, 11, 9),
    pax: 1,
    user: { _id: ADMIN_USER_ID, name: "ADMIN" },
  },
  {
